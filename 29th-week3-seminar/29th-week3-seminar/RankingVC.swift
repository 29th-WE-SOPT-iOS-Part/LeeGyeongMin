...
class RankingVC: UIViewController {
    ...
    func initAppContentList(){
        appContentList.append(contentsOf: [
            ...
            AppContentData(appName: "Nexflix", description: "지금 바로 시청하세요", appIconName: "netflixIcon"),
...
extension RankingVC : UICollectionViewDelegateFlowLayout{
    ...
    //content 외부에 감쌀 inset이 없음
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForSectionAt section: Int) -> UIEdgeInsets {
        return UIEdgeInsets.zero //(0,0,0,0)과 같은 의미
    }
